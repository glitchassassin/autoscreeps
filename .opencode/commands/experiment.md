...
When complete, consult the `screeps-world-expert` subagent about the results and see what ideas it has.
...
Based on its feedback, determine the next planned experiment.
